...
def get_columns(filters):
    if filters.ausfuehrung == 'Auftrag':
        columns = [
            ...
            {"label": _("Vertragstyp"), "fieldname": "contract_type", "fieldtype": "Data", "width": 100},
        ...
        if filters.ausfuehrung == 'Auftrag':
            if outstanding_amount != 0:
                ...
                _data = {
                    ...
                    'contract_type': frappe.db.get_value("Project", order.get('project'), "contract_type") if order.get('project') else None,
