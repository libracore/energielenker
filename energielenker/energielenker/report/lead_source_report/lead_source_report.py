...
def get_columns():
    columns = [
        ...
        {"label": _("Net Amount"), "fieldname": "net_amount", "fieldtype": "Data", "width": 100},
        {"label": _("Customer Advisor (Sales Order)"), "fieldname": "customer_advisor", "fieldtype": "Data", "width": 100},
        {"label": _("Customer Care (Customer)"), "fieldname": "customer_care", "fieldtype": "Data", "width": 100}
    ]
    return columns
