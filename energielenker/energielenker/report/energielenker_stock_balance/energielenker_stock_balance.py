...
def get_columns(filters):
    ...
    columns = [
        ...
        {"label": _("Temporarily deactivated"), "fieldname": "temporarily_deactivated", "fieldtype": "Check", "width": 100}
    ]
...
def get_item_details(items, sle, filters):
    ...
    if filters.get('show_disabled_items'):
        disabled_condition = """"""
    else:
        disabled_condition = """ and ifnull(item.disabled, 0) = 0"""
    ...
    res = frappe.db.sql("""
        ...
        from
            ...
            %s
        where
            item.name in (%s){disabled_condition}
